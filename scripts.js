...
function showWolfenstein() {
    new WinBox({
        root: document.getElementById("desktop"),
        title: "Wolfenstein 3D",
        icon: "https://cdn2.steamgriddb.com/file/sgdb-cdn/icon_thumb/206f6a7ada917912e9389da75d80be3b.png",
        url: "Assets/wf3d/index.html",
        width: "648px",
        height: "430px",
        x: "center",
        y: "center",
...
function helpError() {
    var sound = new Audio("Assets/chord.mp3")
    sound.play();
...
function showRoblox() {
    ...
    const winbox = new WinBox("Error Starting Program", {
        ...
        html: '<div style="position: absolute; left: 50px"><img draggable="false" src="https://win98icons.alexmeub.com/icons/png/msg_error-0.png" style="position: absolute; left: -43px; top: 12px;"><p>How do you expect a game from 2007 to run on a 23 year old operating system?</p><br><button onclick="buttons.close(), showRobloxWindow()" style="margin-left: 125px">Open ROBLOX</button></div>',
    });
    window.buttons = {
        close: function () {
            winbox.close();
